...
+ (MBSpinningCircle*)circleWithSize:(NSSpinningCircleSize)size color:(UIColor*)color {
    float width;
    switch (size) // ranjit change size of circle
    {
...
- (void)drawAnnular
{
    ...
    CGFloat lineWidth = 6.0; //3.25f; //ranjit change width of circle line
    ...
    CGFloat endAngle = ((float)M_PI + startAngle + 2.5); // ranjit add 2 for long round
